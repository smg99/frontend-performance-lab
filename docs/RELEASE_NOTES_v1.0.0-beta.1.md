...
Welcome to the first public beta of **Frontend Performance Lab**!
...
- **Revamped Documentation**: Simplified README and an updated Contributing Guide focusing on developer experience and onboarding.

## 🛠️ CLI Utilities

- `fpl setup`: Auto-configures IDEs.
- `fpl doctor`: Checks system compatibility and connection health.
- `fpl mcp`: Launches the standalone MCP server.

## 💡 What's Next?

In upcoming betas, expect cross-file ProjectGraph analysis, visual dependency graphs, and deeper analyzer rules.

_Please report any bugs or feedback by opening an issue on GitHub!_
