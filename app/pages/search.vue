  ...
  <Container class="py-12 max-w-4xl">
    <div class="mb-12">
      <div class="relative flex items-center w-full">
        ...
        <input
          ...
          class="w-full h-16 pl-16 pr-6 bg-background-surface hover:bg-background-hover focus:bg-background-base rounded-2xl border border-border-subtle focus:border-border-strong text-foreground-primary placeholder:text-foreground-muted transition-all duration-200 outline-none focus:ring-4 focus:ring-border-subtle/50 shadow-sm text-lg"
          autofocus
        />
      </div>
    </div>
    ...
    <div v-else class="space-y-12">
      <section v-for="[groupName, items] in groupedResults" :key="groupName">
        <h2
          class="text-xl font-bold mb-6 flex items-center gap-2 border-b border-border-subtle pb-2"
        >
        ...
        <div class="grid gap-4">
          ...
          >
            <Card
              class="p-5 hover:border-border-strong hover:shadow-md transition-all group flex items-start justify-between"
            >
              <div>
