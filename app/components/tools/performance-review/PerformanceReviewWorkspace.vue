<template>
  <div class="flex h-[calc(100vh-64px)] w-full">
    ...
    <div class="w-1/2 min-w-[400px]">
      <CodeEditor v-model="code" v-model:language="language" @analyze="runAnalysis" />
    </div>
    ...
    <div class="w-1/2 border-l border-border bg-card">
      ...
      >
        <div
          class="bg-card border border-border p-6 rounded-xl shadow-xl flex flex-col items-center"
        >
          <div
