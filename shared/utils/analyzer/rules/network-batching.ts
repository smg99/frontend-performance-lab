...
export const networkBatching: ASTRule = {
  ...
  description: 'Making multiple sequential or unbatched network requests can degrade performance and increase network overhead.',
  severity: 'Warning',
  ...
  confidence: { score: 70, reasoning: 'Detects BlockStatements containing multiple CallExpressions for fetch or axios. False positives may occur if logically separate.', falsePositiveRisk: 'High' },
