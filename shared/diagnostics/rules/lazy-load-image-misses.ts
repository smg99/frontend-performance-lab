...
export const lazyLoadImageMisses: DiagnosticDefinition = {
  ...
  severity: 'medium',
  confidence: 'high',
  summary: 'Images are missing the `loading="lazy"` attribute on a page with multiple images.',
  ...
  impact: 'Slower First Contentful Paint, increased network bandwidth usage on load.',
  howToVerify:
