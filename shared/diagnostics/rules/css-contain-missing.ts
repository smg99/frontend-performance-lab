...
export const cssContainMissing: DiagnosticDefinition = {
  ...
  severity: 'medium',
  confidence: 'medium',
  summary: 'A large element with many children is missing the CSS `contain` property.',
  ...
  impact: 'Increased layout thrashing and slower rendering performance during dynamic updates.',
  howToVerify:
  ...
  recommendedFix: "Add `contain: content;` (or strict/layout) to the parent element's CSS.",
