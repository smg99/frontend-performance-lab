...
export const networkBatching: DiagnosticDefinition = {
  ...
  severity: 'medium',
  confidence: 'medium',
  summary: 'Multiple unbatched network requests are made in sequence within the same block.',
  ...
  impact: 'Slower time to interactive and increased network overhead.',
  howToVerify:
  ...
  references: ['https://web.dev/promises-all/'],
  framework: 'universal',
  ruleVersion: '1.0.0'
}
